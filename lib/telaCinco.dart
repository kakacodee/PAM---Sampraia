...
import 'package:url_launcher/url_launcher.dart';
 void main(){
  runApp(const MaterialApp (title: "App4",
      home: telaCinco(),));
      ...
      body: const SingleChildScrollView(
        ...
        <Widget>[
          ...
          Text('Peruíbe',
           ...
           Image(image: AssetImage('img/praia4.png'), ),
           Padding(padding: EdgeInsets.only(top: 40),),
           
           Text('Peruíbe é uma cidade litorânea em São Paulo, conhecida por suas praias e a Estação Ecológica da Juréia-Itatins. O turismo é a principal atividade econômica, atraindo visitantes para suas belezas naturais e áreas de preservação ambiental.',
           //textAlign: ,
           style: TextStyle(
